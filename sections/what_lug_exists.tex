...
اولین گام شما باید جستجو برای یافتن لاگ‌های موجود در نزدیکی محل موردنظرتان باشد. 
{\itshape
...
هر ۶ ایالت استرالیا به‌علاوه قلمرو پایتختی استرالیا، ۷۶ نقطه/شهر در هند و
بیش از ۱۰۰ کشور دیگر شامل ایران، روسیه، چین، بیشتر اروپای شرقی و غربی
و خش‌های زیادی از آفریقا، آسیا، آمریکای جنوبی، آمریکای مرکزی، اقیانوسیه، کارائیب.
(این لیست شامل گروه‌های اینترنتی
\emph{میت آپ}\footnote{\texttt{\url{http://linuxmafia.com/faq/Essays/meetup.html}}}
نمی ‌شود)
...
\begin{itemize}
\item \emph{کرلی: گروه کاربری لینوکس}\footnote{\texttt{\url{https://curlie.org/en/Computers/Software/Operating_Systems/Linux/User_Groups}}}
%\item \emph{\url{Curlie: Linux User Groups}}\footnote{\texttt{\url{https://curlie.org/en/Computers/Software/Operating_Systems/Linux/User_Groups}}}

\item \emph{لیست لاگ لی}\footnote{\texttt{\url{http://www.lea-linux.org/documentations/index.php/Annuaire:LUG_\%26_assos_nationales}}}
(زبان آن فرانسه است)
%\item \emph{\url{L\'ea-Linux List}}\footnote{\texttt{\url{http://www.lea-linux.org/documentations/index.php/Annuaire:LUG_\%26_assos_nationales}}}
%	(text is in French)

\item \emph{گروه کاربری لینوکس انگلستان}\footnote{\texttt{\url{http://www.lug.org.uk/}}}
%\item \emph{\url{UK Linux User Groups}}\footnote{\texttt{\url{http://www.lug.org.uk/}}}

\item \emph{لینوکس استرالیا}\footnote{\texttt{\url{http://linux.org.au/usergroups}}}
%\item \emph{\url{Linux Australia}}\footnote{\texttt{\url{http://linux.org.au/usergroups}}}

\item \emph{لیست لاگ‌های آسیا و هند}\footnote{\texttt{\url{http://www.wikiwikiweb.de/LugsList}}}
%\item \emph{\url{LUGs List for India and Asia}}\footnote{\texttt{\url{http://www.wikiwikiweb.de/LugsList}}}

\item \emph{گروه کاربری لینوکس ایتالیا}\footnote{\texttt{\url{http://lugmap.linux.it/}}}
%\item \emph{\url{I Linux User Group italiani}}\footnote{\texttt{\url{http://lugmap.linux.it/}}}

\item \emph{لینک‌های گروه کاربری در لینوکس‌لینکس}\footnote{\texttt{\url{https://www.linuxlinks.com/?s=User+Group}}}
%\item \emph{\url{Linux Links UserGroups}}\footnote{\texttt{\url{https://www.linuxlinks.com/?s=User+Group}}}

\item \emph{لیست گروه‌های \LRE{LibrePlanet}}\footnote{\texttt{\url{http://libreplanet.org/wiki/Group_list}}}
(فقط موارد وابسته به
\emph{اف‌اس‌اف}\footnote{\LRE{FSF}}
لیست شده اند)
%\item \emph{\url{LibrePlanet Group List}}\footnote{\texttt{\url{http://libreplanet.org/wiki/Group_list}}}
% (lists FSF affiliates only)

\item \emph{\url{LinuxUserGroups.org}}\footnote{\texttt{\url{https://www.linuxusersgroups.org/}}}
...
\emph{\url{comp.os.linux.announce}}\footnote{\texttt{\url{news:comp.os.linux.announce}}}،
\emph{\url{comp.os.linux.misc}}\footnote{\texttt{\url{news:comp.os.linux.misc}}}
و یا
\emph{یوزنت}\footnote{\LRE{Usenet}}
...
{\bfseries {\itshape
تقریباً همیشه تعداد بیشتر به معنای قدرت بیشتر، نفوذ بیشتر و کارایی بیشتر است..
}}
...
یکی از این تعهد‌ها، در نظر گرفتن تمام حقایق مرتبط و قدردانی از تاثیر لاگ‌های
دیگر می‌باشد.
