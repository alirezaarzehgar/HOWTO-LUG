...
\item \emph{لیست گروه‌های \lr{LibrePlanet}}\footnote{\texttt{\url{http://libreplanet.org/wiki/Group_list}}}
(فقط موارد وابسته به
\emph{اف‌اس‌اف}\footnote{\lr{FSF}}
لیست شده اند)
