...
\item
مراکز و کسب‌ و کار‌هایی را در محل خود پیدا کنید که به شکل گرفتن لاگ کمک
خواهند کرد.
...
\item
هرچه سریع‌تر برای لاگ یک راهبر رسمی انتخواب کنید. صاحب‌منصبانی مناسب می‌توانند شامل
...
و نرم‌افزار آزاد/متن‌باز حمایت و پشتیبانی کنید.
...
\emph{«جایزه دم در»}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/Door_prize}}}
تهیه کنند.
...
\item
جلسات‌ خود را از طریق گروه‌های یوزنت، نشریات محلی کامپیوتری و روزنامه‌ها
...
\item
لطفا
\emph{پروژه مستندسازی لینوکس}\footnote{\texttt{\url{https://tldp.org}}}
...
آموزش‌ها، راهنما و \LRE{HOWTO}‌های فنی و موارد دیگر باشد.
