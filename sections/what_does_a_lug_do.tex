...
وجود دارد که کار
\emph{دون مارتی}\footnote{\lr{Don Marti}}
می‌باشد.
...
\emph{گروه‌افزار اوت‌لوک/استک‌اکسچنج}\footnote{\lr{Outlook/Exchange groupware}}
...
\emph{دسترسی سطح بالا}\footnote{\lr{High availability}}،
...
\emph{پروژه مستند سازی لینوکس}\footnote{\lr{Linux Documentation Project}}
...
کاربران
%\item users
\item \emph{مشاوران}\footnote{\lr{consultants}}
%\item consultants
\item
...
با نام
\emph{مجله حرفه‌ای لینوکس}\footnote{\lr{Linux Pro Magazine}}
شناخته می‌شود.)،
\emph{متن‌باز برای تو}\footnote{\lr{https://www.opensourceforu.com}}
(هندی و سابقا با نام
\emph{لینوکس برای تو}\footnote{\lr{LINUX For You}}
شناخته می‌شد.)،
...
به مشاوران
(\emph{\lr{consultant}}\footnote{\lr{Professional advisor}})
...
ذاتا از
\emph{«فرهنگ هدیه»}\footnote{\lr{Gift culture}}
پیروی می‌کنند.
...
\emph{گروه کاربران تک (\lr{TUG})}\footnote{\texttt{\url{http://www.tug.org/}}}
...
ارائه ویرایش‌های
\emph{ادبیات کلاسیک اسکاندیناوی}\footnote{\lr{classic Nordic (Scandinavian) literature}}
...
\emph{کلاوس ناپر}\footnote{\lr{Klaus Knopper}}
که
\emph{ناپیکس}\footnote{\lr{Knoppix}}
...
\emph{بسته آموزشی برای دانش‌آموزان}\footnote{\lr{K-12 Box}}
را به‌عنوان یک بسته
\emph{کامپیوتر ورک استیشن پلاگ و پلی}\footnote{\lr{Plug and Play workstation computer}}
...
این افزایش روزافزون
\emph{پایگاه کاربری}\footnote{\lr{User base}}
...
یک کرنل جدید،
\emph{ری‌کامپایل}\footnote{\lr{recompiling}}
کردن یک کرنل قدیمی، دست‌وپنجه نرم کردن با یک
\emph{مدیر پنجره}\footnote{\lr{window manager}}
...
می‌تواند در
\emph{لیست پستی}\footnote{\lr{mailing list}}،
