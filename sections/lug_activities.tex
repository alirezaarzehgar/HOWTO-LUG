...
\emph{استقرار}\footnote{\LRE{deploy}}
...
\emph{دستورالعمل برای یک گروه کاربری لینوکس موفق}\footnote{\texttt{\url{http://linuxmafia.com/faq/Linux_PR/newlug.html}}}،
...
\item
صفحه وب شما نیاز به یک \LRE{URL} قابل‌قبول دارد.
...
\begin{itemize}
\item
\emph{مشتاقان لینوکس آتلانتا}\footnote{\texttt{\url{http://ale.org/}}}
%\emph{Atlanta Linux Enthusiasts} \texttt{http://ale.org/}
\item
\emph{لینوکس و یونیکس بوستون}\footnote{\texttt{\url{http://www.blu.org/}}}
%\emph{Boston Linux and Unix} \texttt{http://www.blu.org/}
\item
\emph{گروه کاربران لینوکس دوسلدورف}\footnote{\texttt{\url{http://www.dlug.de/}}}
%\emph{Dusseldorfer Linux Users Group} \texttt{http://www.dlug.de/}
\item
\emph{گروه کاربران لینوکس دهلی هند}\footnote{\texttt{\url{https://linuxdelhi.org/}}}
%\emph{India Linux Users Group Delhi} \texttt{https://linuxdelhi.org/}
\item
\emph{گروه کاربران لینوکس اسرائیل}\footnote{\texttt{\url{http://www.iglu.org.il/}}}
%\emph{Israeli Group of Linux Users} \texttt{http://www.iglu.org.il/}
\item
\emph{گروه کاربران لینوکس کره}\footnote{\texttt{\url{http://www.lug.or.kr/}}}
%\emph{Korean Linux Users Group} \texttt{http://www.lug.or.kr/}
\item
\emph{لینوکس مکزیکو}\footnote{\texttt{\url{http://cofradia.org/}}}
%\emph{Linux Mexico (La Cofradia Digital)} \texttt{http://cofradia.org/}
\item
\emph{گروه کاربری لینوکس استرالیا}\footnote{\texttt{\url{http://www.luga.at/}}}
%\emph{Linux User Group Austria} \texttt{http://www.luga.at/}
\item
\emph{گروه کاربری لینوکس دیویس}\footnote{\texttt{\url{http://www.lugod.org/}}}
%\emph{Linux User Group of Davis} \texttt{http://www.lugod.org/}
\item
\emph{گروه کاربری لینوکس روچستر}\footnote{\texttt{\url{http://www.lugor.org/}}}
%\emph{Linux User Group of Rochester} \texttt{http://www.lugor.org/}
\item
\emph{گروه کاربران لینوکس ندرلند یا \LRE{NLLGG}}\footnote{\texttt{\url{http://www.nllgg.nl/}}}
%\emph{Nederlandse Linux Gebruikers Groep (Netherlands Linux Users Group or NLLGG)} \texttt{http://www.nllgg.nl/}
\item
\emph{گروه کاربران لینوکس تگزاس شمالی}\footnote{\texttt{\url{http://www.ntlug.org/}}}
%\emph{North Texas Linux Users Group} \texttt{http://www.ntlug.org/}
\item
\emph{گروه کاربران لینوکس اتاوا در کانادا}\footnote{\texttt{\url{https://wiki.linux-ottawa.org/doku.php}}}
%\emph{Ottawa Canada Linux Users Group} \texttt{https://wiki.linux-ottawa.org/doku.php}
\item
\emph{گروه کاربران لینوکس پرووانس}\footnote{\texttt{\url{http://plugfr.org/}}}
%\emph{Provence Linux Users Group} \texttt{http://plugfr.org/}
\item
\emph{گروه کاربران لینوکس توکیو}\footnote{\texttt{\url{http://www.tlug.jp/}}}
%\emph{Tokyo Linux Users Group} \texttt{http://www.tlug.jp/}
\item
\emph{گروه کاربری لینوکس ترکیه}\footnote{\texttt{\url{http://www.linux.org.tr/}}}
...
\item {\large لاگ مشهد}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/mashhadlug}
\item [گروه تلگرام] \url{https://t.me/+8PnN0irrwzk3Zjk8}
\item [گیت] \url{https://github.com/mashhadlug}
\end{description}

\item {\large لاگ دانشگاه فردوسی مشهد}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/fum_lug}
\item [گروه تلگرام] \url{https://t.me/ferdowsilug}
\end{description}

\item {\large لاگ ارومیه}
\begin{description}
\item [وبسایت] \url{https://urumlug.ir/?ref=unrivaled.ir}
\item [کانال تلگرام] \url{https://t.me/urumlug}
\item [گروه تلگرام] \url{https://t.me/Urumlug_group}
\end{description}

\item {\large لاگ البرز}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/alborzlug}
\end{description}

\item {\large لاگ استهبان}
\begin{description}
\item [گروه تلگرام] \url{https://t.me/EstahbanLug}
\end{description}

\item {\large لاگ فسا}
\begin{description}
\item [گروه تلگرام] \url{https://t.me/FasaLUG}
\end{description}

\item {\large لاگ جهرم}
\begin{description}
\item [گروه تلگرام] \url{https://t.me/Jahrom_LUG}
\end{description}

\item {\large لاگ اصفهان}
\begin{description}
\item [گروه تلگرام] \url{https://t.me/lugisfahan}
\end{description}

\item {\large لاگ بندرعباس}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/bndlugg}
\item [گروه تلگرام] \url{https://t.me/bndluggg}
\end{description}

\item {\large لاگ پرشین}
\begin{description}
\item [وبسایت] \url{http://persianlug.com/}
\item [کانال تلگرام] \url{https://t.me/persianlug}
\item [گروه تلگرام] \url{https://t.me/persianlug_chat/125}
\end{description}

\item {\large لاگ تهران}
\begin{description}
\item [وبسایت] \url{https://tehlug.org/?ref=unrivaled.ir}
\item [کانال تلگرام] \url{https://t.me/TehranLUG}
\item [گروه تلگرام] \url{https://t.me/+hSwSZQG0oophYzg0}
\item [گیت] \url{https://github.com/tehlug}
\end{description}

\item {\large لاگ جامعه لینوکسی شیراز}
\begin{description}
\item [وبسایت] \url{https://sudoshz.ir}
\item [کانال تلگرام] \url{https://t.me/shirazlinuxcommunity}
\item [گروه تلگرام] \url{https://t.me/sudoshz}
\end{description}

\item {\large دورهمی گنو}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/gnumeetup}
\end{description}

\item {\large ریلاگ}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/relug_info}
\item [گروه تلگرام] \url{https://t.me/relugs}
\end{description}

\item {\large لاگ زنجان}
\begin{description}
\item [وبسایت] \url{https://zanjanlug.ir/}
\item [گروه تلگرام] \url{https://t.me/zanjanlug}
\end{description}

\item {\large لاگ شیراز}
\begin{description}
\item [وبسایت] \url{https://shirazlug.ir/?ref=unrivaled.ir}
\item [کانال تلگرام] \url{https://t.me/shirazlug}
\item [گروه تلگرام] \url{https://t.me/lugshiraz}
\item [گیت] \url{https://framagit.org/shirazlug}
\end{description}

\item {\large لاگ کرج}
\begin{description}
\item [وبسایت] \url{https://karajlug.org/}
\item [گروه تلگرام] \url{https://t.me/+QRReI-w2ZJ8V5r4l}
\end{description}

\item {\large لاگ قزوین}
\begin{description}
\item [کانال تلگرام] \url{https://t.me/qazvin_lug}
\item [گروه تلگرام] \url{https://t.me/joinchat/BNxsFT47uBsVdWB5RXr1ug}
\end{description}

\item {\large لاگ کرمان}
\begin{description}
\item [گروه تلگرام] \url{https://t.me/kermanlinux/1}
\end{description}

\item {\large لاگ گیلان}
\begin{description}
\item [گروه تلگرام] \url{https://t.me/+P2Pv304Nh19E_uiD}
\end{description}
\end{itemize}