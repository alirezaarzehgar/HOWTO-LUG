...
کندال گرانت
\emph{کلارک کندال گرانت}\footnote{\LRE{Kendall Grant Clark}}
بوده است.
این مستند می‌تواند تحت مجوز بین‌المللی
\emph{\url{Creative Commons Attribution-ShareAlike 4.0}}\footnote{\texttt{\url{http://creativecommons.org/licenses/by-sa/4.0/}}}
...
\emph{لینوکس مافیا}\footnote{\texttt{\url{http://linuxmafia.com/lug/}}}
و
...
\emph{این پروژه}\footnote{\texttt{\url{https://github.com/alirezaarzehgar/HOWTO-LUG}}}
...
از
\emph{کندال گرانت کلارک}\footnote{\LRE{Kendall Grant Clark}}
...
تشکری صمیمانه از
\emph{کریس براون}\footnote{\LRE{Chris Browne}}
...
\begin{itemize}
\item \emph{متیو کریگ}\footnote{\LRE{Matthew Craig}}
\item \emph{جف گارواس}\footnote{\LRE{Jeff Garvas}}
\item \emph{گرگ‌هانکینز}\footnote{\LRE{Greg Hankins}}
\item \emph{جیمز هرتزلر}\footnote{\LRE{James Hertzler}}
\item \emph{توماس کاپلز}\footnote{\LRE{Thomas Kappler}}
\item \emph{مارتین کارلسون}\footnote{\LRE{Martin Karlsson}}
\item \emph{هوگو ون در کویج}\footnote{\LRE{Hugo van der Kooij}}
\item \emph{روهیت کومار}\footnote{\LRE{Rohit Kumar}}
\item \emph{دیوید لویر}\footnote{\LRE{David Lawyer}}
\item \emph{چارلز لیندال}\footnote{\LRE{Charles Lindahl}}
\item \emph{دون مارتی}\footnote{\LRE{Don Marti}}
\item \emph{وینچنزو ویرجیلیو}\footnote{\LRE{Vincenzo Virgilio}}
\end{itemize}
