...
\emph{آی‌اس‌پی}\footnote{\LRE{Internet Service Provider}}ها
...
از
\emph{کریس برواون}\footnote{\texttt{\url{mailto:cbbrowne@cbbrowne.com}}}
...
خبرنگاری به نام
\emph{توماس کپلر}\footnote{\texttt{\url{mailto:Thomas.Kappler@stud.uni-karlsruhe.de}}}
...
\emph{«انجمن اقتصادی»}\footnote{\LRE{Economical Association}}.
...
پیشنهاد من کتاب
\emph{\url{Non-Lawyers Non-Profit Corporation}}\footnote{\texttt{\url{https://www.alibris.com/The-Non-Lawyers-Non-Profit-Corporation-Kit-Kermit-Burton/book/4711443}}}
...
\emph{اینترنت آرشیو}\footnote{\texttt{\url{https://archive.org/details/alphacorporation00kerm}}}
دریافت کنید.)
...
حالت دیگری نیز وجود دارد که در آن اداره مالیات داخلی \LRE{IRS} برای لاگ
...
به صورت فایل آکروبات از وبسایت \LRE{IRS} قابل دسترس است.
...
برای مثال
\emph{۵۰۱(سی)(۳)}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/501(c)(3)_organization}}})
...
\emph{پوشش بیمه طرح دعوی در دادگاه یا چتر بیمه}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/Umbrella_insurance}}}
...
\item
حتی اگر \LRE{IRS} یک گروه را رسما معاف از مالیات کند، الزاما به این معنی نیست
...
\emph{۵۰۱ (سی)(۷)}\footnote{\texttt{\url{http://web.archive.org/web/20090818124349/http://www.t-tlaw.com/lr-06.htm}}}
قید شده است.
...
هیچ توجیه و دلیلی ندارد. \LRE{IRS} اهمیتی به سازمان‌هایی که درآمد سالانه زیر ۲۵۰۰۰ دلار دارند نمی‌دهد
و آنها مشمول مالیات نخواهند شد. از همین رو برای یک گروه کاربری کوچک هیچ نیازی به ثبت رسمی نخواهد بود.
\footnote{\url{http://www.guidestar.org/news/features/990_myths.jsp}}
...
\emph{قانون حمایت از داوطلبان فدرال در سال 1997}\footnote{\texttt{\url{http://www.congress.gov/cgi-bin/query/C?c105:./temp/~c105ss2v68}}}
داوطلبان سازمان‌های خیریه ۵۰۱(سی)(۳) را در برابر دعاوی حقوقی محافظت نمی‌کند.
\footnote{\url{http://www.runquist.com/article_vol_protect.htm}}
...
\emph{خارج از موضوع}\footnote{\texttt{\url{Off-topic}}}
...
\emph{پارتیشن مجیک}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/PartitionMagic}}}
...
\emph{کلدرا}\footnote{\LRE{Caldera}}، \emph{رد هت}\footnote{\LRE{Red Hat}} و \emph{سوزه}\footnote{\LRE{SUSE}}
...
خود را پایان داد و نام خود را به گروه \LRE{SCO} تغییر داد. پس از آن یک دعوی حقوقی بزرگ در رابطه با
...
البته هنوز هم از کلدرا بابت اهدای سخت‌افزار برای کمک به توسعه پشتیبانی کرنل از \LRE{SMP} توسط
\emph{آلن کاکس}\footnote{\LRE{Alan Cox}}،
کمک‌های مالی به توسعه \LRE{RPM} ، مشارکت‌های گسترده قدیمی او در سورس کرنل و تلاش‌های او
...
لایسنس \LRE{BSD} به کمپانی‌ها اجازه می‌دهد که کرنل و کتابخانه‌های سی را برای خود توسعه
داده و عمومی هم نکنند. برخی از کاربران این لاینسن را به لایسنس \LRE{GPL} ترجیح می‌دهند.
لایسنس \LRE{GPL} باعث می‌شود بالجبار نرم‌افزار برای همیشه آزاد بماند همانطور که این مسئله
...
\begin{itemize}
\item 
نظرات بسیاری راجع به لایسنس \LRE{GPL} و حتی لایسنس‌های متن‌باز دیگر و کارکرد آنها وجود دارد.
(البته عمدتا این نظرات نادرست هستند و مردم درک درستی از \LRE{GPL} و جایگزین‌های آن ندارند.
این بحث‌ها برای افرادی که دانش کافی ندارند واقعا بی‌فایده هستند و نیازی نیست به آنها پرداخته شود.
اما اکر افرادی بودند که واقعا مایل بودند این مطالب رو بیاموزند، لطفا آنها را به لیست پستی «\LRE{license-discuss}» 
در \LRE{OSI} و همچنین «\LRE{debian-legal}» از پروژه دبیان ارجاع بدهید. آنها در این دو لیست پستی
...
هم در کرنل لینوکس، \LRE{X.org} و \LRE{gcc} مشارکت کرده اند و از همین رو نمی‌توان آنها
را الزاما بد دانست.
...
همین میدان \LRE{KDE} در مقابل \LRE{GOME} و هزاران نرم‌افزار دیگر رقابت می‌کنند.
...
\footnote{\url{https://en.wikipedia.org/wiki/Door_prize}}
