...
\emph{آی‌اس‌پی}\footnote{\lr{Internet Service Provider}}ها
...
\emph{«انجمن اقتصادی»}\footnote{\lr{Economical Association}}.
...
\emph{کلدرا}\footnote{\lr{Caldera}}، \emph{رد هت}\footnote{\lr{Red Hat}} و \emph{سوزه}\footnote{\lr{SUSE}}
...
\emph{آلن کاکس}\footnote{\lr{Alan Cox}}،
