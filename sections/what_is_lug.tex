...
\emph{گروه کاربران لینوکس}\footnote{\lr{Linux Users Group (LUG)}}
...
\emph{اف‌اس‌اف}\footnote{\lr{Free Software Foundation}}
...
\footnote{Free programmers are happy programmers are effective programmers}
}
...
\emph{خارج از موضوع}\footnote{\lr{Off topic}}
اعلام شود.
\end{caveat}
...
\emph{آی‌بی‌ام}\footnote{\lr{IBM}}، \emph{مایکروسافت}\footnote{\lr{Microsoft}} و \emph{سان}\footnote{\lr{Sun}}
