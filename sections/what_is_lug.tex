...
\emph{گروه کاربران لینوکس}\footnote{\LRE{Linux Users Group (LUG)}}
...
{\bfseries آزاد}
تحت لایسنس
\emph{گنو}\footnote{\LRE{GNU}}
(و یا دیگر پروانه‌های متن‌باز/نرم‌افزار آزاد که گاها شامل تعدادی پکیج‌های انحصاری نیز هستند) 
نگهداری می‌شود. بنابراین سورس کد، آزاد و برای همیشه در دسترس همگان خواهد بود.
...
\emph{پروژه گنو}\footnote{\texttt{\url{http://www.gnu.org/gnu/gnu-history.html}}}
...
\emph{اف‌اس‌اف}\footnote{\LRE{Free Software Foundation}}
...
\footnote{\LRE{Free programmers are happy programmers are effective programmers}}
}
...
\emph{نمایندگی فروش}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/Value-added_reseller}}}
...
\footnote{\url{https://en.wikipedia.org/wiki/Boston_Computer_Society}}
...
\emph{بی‌بی‌اس}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/Bulletin_board_system}}}
اجرا می‌کردند. با ظهور اینترنت، خیلی از سرویس‌هایی که گروه‌های کاربری
برای اولین‌بار فراهم کرده بودند به سرویس‌هایی مانند
\emph{کامپیوسرو}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/CompuServe}}}
و وب مهاجرت کردند.
...
اما در جلسات لاگ به‌طور کلی این طرز فکر اعمال نمی‌شود. کپی نامحدود از گنو/لینوکس ممنوع نیست،
...
\emph{باندل}\footnote{\LRE{Bundle}}
می‌کنند که این امر
دیگر اجازه بازنشر عمومی آنها را به دارنده محصول نمی‌دهد. اگر شک دارید شرایط لاینسنس را بررسی کنید.
...
\emph{خارج از موضوع}\footnote{\LRE{Off topic}}
اعلام شود.
\end{caveat}
...
کاهش مشابه‌ای را در تعداد کاربران و فعالیت‌ها مشاهده کردند. علل این اتفاق قابل بحث است
...
و تخصصی‌تر‌ (دوآپس، بیوانفورماتیک، رایانش ابری، رایانش نهفته و موارد دیگر)
موردبحث قرار گیرند.
...
\footnote{reputation-based collaborative sites}
مانند
\emph{استک اکسچنج}\footnote{\texttt{\url{http://unix.stackexchange.com/}}},
\emph{استک اورفلو}\footnote{\texttt{\url{http://stackoverflow.com/}}},
\emph{داک تایپ}\footnote{\texttt{\url{http://doctype.com/}}},
\emph{کد پراجکت}\footnote{\texttt{\url{http://www.codeproject.com/}}}
و
\emph{سرور فالت}\footnote{\texttt{\url{http://serverfault.com/}}}
لازم‌ به ذکر است که با افزایش مهارت سرچ کاربران نیاز به لاگ‌ها کمتر شده
و فعالیت اصلی کاربران به‌سمت سایت‌های
\emph{نرم‌‌افزار به‌عنوان سرویس}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/Software_as_a_service}}}
...
(\emph{\url{SPoFs}}\footnote{\texttt{\url{https://en.wikipedia.org/wiki/Single_point_of_failure}}})
بررسی کنید. اطمینان حاصل کنید که درصورت بروز مشکل راه بازگشتی وجود دارد.
از همه‌چیز بکاپ بگیرید و آنها را تست کنید.
{\bfseries
مطمئن شوید امور مهم لاگ فقط وابسته به یک نفر نیست.
(در لاگ نباید قدرت به‌طور انحصاری در دست یک نفر باشد)
}
...
فعالیت کمتر یا با دفعات کمتر بهتر از خطر خروج مردم از لاگ می‌باشد.
...
نخواهند ماند و از مشارکت دست خواهند کشید. اگر گروه به‌جای تکنیکال شدن
...
\emph{آی‌بی‌ام}\footnote{\LRE{IBM}}، \emph{مایکروسافت}\footnote{\LRE{Microsoft}} و \emph{سان}\footnote{\LRE{Sun}}
